...
from modeling.unet import Unet as unet
...
class Unet(object):
    _defaults = {
        "model_path"        : 'weights/ep100-loss0.455-val_loss0.515.pth',
    ...
    def preprocess_input(self, image):
        ...
        image /= 7800.0
        image[image < 0] = 0
        image = np.expand_dims(np.array([image, image, image]), axis=0)
    ...
    def detect_image(self, image):
        ...
        #---------------------------------------------------------#
        images = self.preprocess_input(image)
